...
const SparklineCard = ({ title, history, color }) => {
  ...
  return (
    <div className="flex-1 flex justify-between items-center p-3 rounded-lg lg:rounded-xl shadow-md bg-white dark:bg-card-dark hover:shadow-lg transition animate-fadeIn">
