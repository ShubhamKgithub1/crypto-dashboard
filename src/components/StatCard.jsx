...
const StatCard = ({ name, price, change, changeType, data }) => {
  ...
  return (
    <div
      ...
      className="bg-slate-600 text-white dark:bg-indigo-700 px-2 py-2 md:py-4 md:px-4 rounded-lg lg:rounded-xl shadow-md transition hover:shadow-lg flex justify-between items-center cursor-pointer animate-fadeIn"
    >
      <div>
